...
const FAQS = [
  {
    q: "Is CoinfyChain suitable for beginners?",
  ...
  },
  {
    ...
    a: "We use AES-256 encryption at rest and in transit, enforce IP whitelisting, and never request withdrawal permissions. CoinfyChain is SOC 2 Type II certified.",
  },
  {
