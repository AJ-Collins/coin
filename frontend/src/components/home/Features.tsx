const FEATURES = [
  {
    ...
    color: "brandViolet", // Brand violet accent
...
const colorMap = {
  brandViolet:{ bg: "bg-[#a78bfa]/10", border: "border-[#a78bfa]/20", icon: "text-[#a78bfa]", tag: "text-[#a78bfa]", glow: "hover:shadow-[0_0_20px_rgba(167,139,250,0.1)] hover:border-[#a78bfa]/40" },
    ...
    <section id="features" className="relative z-10 px-4 py-20 md:py-28 max-w-7xl mx-auto border-b border-[#1a1f28]">
      ...
      <div className="flex flex-col items-center text-center mb-20">
        ...
        <h2 className="text-4xl md:text-5xl lg:text-6xl font-black mb-6 leading-[1.1] tracking-tight">
          ...
          <span className="text-[#a78bfa] drop-shadow-md">refuse to be slow.</span>
        </h2>
