    ...
    <section className="relative z-10 overflow-hidden border-b border-[#1a1f28]">
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-4 pt-24 pb-28 md:pt-32 md:pb-40">
        ...
        <div className="inline-flex items-center gap-3 font-mono text-xs text-[#9ca3af] border border-[#1a1f28] rounded-sm px-4 py-2 mb-10 bg-[#0a0c14]/80 backdrop-blur-sm">
          ...
          <span>SIGNAL ACCURACY <span className="text-[#a78bfa] font-semibold">94.7%</span></span>
        </div>
        ...
        <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-[84px] font-black leading-[0.95] mb-6 tracking-tight drop-shadow-lg">
          ...
          <br />
          <span className="text-[#a78bfa]">Act in milliseconds.</span>
        </h1>
        ...
        <p className="text-base sm:text-lg md:text-xl text-[#9ca3af] max-w-lg md:max-w-2xl mb-10 leading-relaxed font-light drop-shadow-md">
          CoinfyChain scans order flow continuously and fires scalp signals the
        ...
        <div className="flex flex-col sm:flex-row items-center gap-3 mb-8 w-full sm:w-auto px-4">
          <Link to="/register" className="w-full sm:w-auto">
            <button className="w-full sm:w-auto bg-[#a78bfa] text-[#05070a] font-black text-base px-8 py-4 rounded-sm hover:bg-[#c4b5fd] transition-all duration-200 hover:scale-[1.02] active:scale-95 cursor-pointer shadow-[0_0_20px_rgba(167,139,250,0.15)]">
              Start for free →
            </button>
          </Link>
          <Link to="/login" className="w-full sm:w-auto">
            <button className="w-full sm:w-auto flex items-center justify-center gap-2.5 border border-[#1a1f28] text-white font-semibold text-base px-8 py-4 rounded-sm hover:border-[#a78bfa]/40 hover:bg-[#0a0c14]/80 backdrop-blur-sm transition-all duration-200 cursor-pointer">              
              Sign In
            </button>
          </Link>
        </div>
