        ...
        <form onSubmit={handlePasskeySubmit} className="flex flex-col gap-3">
          <div className="relative w-full">
            ...
            <input
              ...
              className="w-full bg-[#05070a] border border-[#1a1f28] rounded-xl pl-10 pr-4 py-3.5 text-sm text-white placeholder-gray-600 outline-none focus:border-[#39ff88]/40 transition-colors font-mono disabled:opacity-50"
            />
          </div>
