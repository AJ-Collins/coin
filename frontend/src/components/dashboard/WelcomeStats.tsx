...
export default function WelcomeStats() {
  ...
  return (
    <div className="px-4 md:px-6 pt-8 pb-6 bg-gradient-to-b from-[#39ff88]/[0.04] to-transparent">
      <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-8">
        ...
        <div className="flex gap-3">
          <Link to="/trade">
            <button className="flex items-center gap-2 bg-[#39ff88] text-[#05070a] text-sm font-bold px-4 py-2.5 rounded-lg hover:bg-[#5dffa1]">
